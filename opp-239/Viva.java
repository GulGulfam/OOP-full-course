class Viva {
	...
	public Viva(){
		this.setName("Gul");
		this.setRollNo(21);
		this.setPercentage(13.0);
	}

	public Viva(String n){
    	name=n;
    ...
    public Viva(double per){
    	percentage=per;
    }
	 public Viva(String n, int r){
    	name=n;
    	rollNo=r;
    }
    public Viva(int r, String n){
    	
    	rollNo=r;
    	name=n;
    }

    public Viva(String n, double per){
    	name=n;
    	percentage=per;
    }

    public Viva(double per, String n){
    	percentage=per;
    	name=n;
    }

    public Viva(int r, double per){
    	
    	rollNo=r;
    	percentage=per;
    }

    public Viva(double per, int r){
    	
    	percentage=per;
    	rollNo=r;
    }
    public Viva(String n,  double per, int r){
    	name=n;
    	percentage=per;
		rollNo=r;    	
    ...
    public Viva(double per, int r, String n){
    	percentage=per;
    	rollNo=r;
    	name=n;
    }
    public Viva(int r, String n,  double per){
    ...
    public Viva(int r, double per, String n){
    ...
    public Viva(String n, int r, double per){
    	name=n;
    	rollNo=r;
    	percentage=per;
    }

    public Viva(double per, String n, int r){
    	percentage=per;
    	name=n;
    	rollNo=r;
    }
	...
	public void setPercentage(double p){
	 ...
	 public boolean isBetter(Viva arg){
	 	return (this.percentage>arg.percentage) ;
	 }
	 public Viva isBest(Viva arg1,Viva arg2,Viva arg3,Viva arg4,Viva arg5,Viva arg6,Viva arg7,
	 Viva arg8,Viva arg9,Viva arg10 ){
