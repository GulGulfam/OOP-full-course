class Student {
	...
	public void setPercentage(double p){
	 ...
	 public boolean isBetter(Student arg){
	 	if (this.percentage>arg.percentage) {
	 		return true;
	 ...
	 Student arg8,Student arg9,Student arg10 ){
	 	if (arg1.isBetter(arg2) && arg1.isBetter(arg3) && arg1.isBetter(arg4) && arg1.isBetter(arg5) && arg1.isBetter(arg6) && arg1.isBetter(arg7)
	 		...
	 		&& arg8.isBest(arg7) && arg8.isBest(arg9) && arg8.isBest(arg10) ) {
	 		return arg8;
	 		
	 	}

	 		else if (arg9.isBest(arg1) && arg9.isBest(arg2) && arg9.isBest(arg3) && arg9.isBest(arg4) && arg9.isBest(arg5) && arg9.isBest(arg6)
	 		&& arg9.isBest(arg7) && arg9.isBest(arg8) && arg9.isBest(arg10) ) {
	 		return arg9;
